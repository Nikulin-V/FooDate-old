    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_date', models.DateTimeField(null=True, validators=[django.core.validators.MaxValueValidator(datetime.datetime(2022, 6, 25, 18, 52, 22, 846323))], verbose_name='Дата изготовления')),
                ('purchase_date', models.DateTimeField(null=True, validators=[django.core.validators.MaxValueValidator(datetime.datetime(2022, 6, 25, 18, 52, 22, 846323))], verbose_name='Дата покупки')),
            ],
            options={
                'abstract': False,
            },
